...
def educational_articles():
    ...
    st.markdown("## Optimization: Overview and Examples in Technical Analysis")
    st.markdown("[Read the full article](https://www.investopedia.com/terms/o/optimization.asp)")
...
def video_content():
    ...
    st.video("https://www.youtube.com/watch?v=zwXPrwGCavU")
    # Add more videos here
    st.video("https://www.youtube.com/watch?v=kkSL9UC-aMU")
    st.video("https://www.youtube.com/watch?v=p7HKvqRI_Bo")
    st.video("https://www.youtube.com/watch?v=CMQLdJa64Wk")
